...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub clear()
		  ...
		  ExpirationMonthPopup.ListIndex = -1
		  ExpirationYearPopup.ListIndex = -1
	...
	#tag Method, Flags = &h0
		Function getCreditCard() As CreditCard
		  ...
		  dim expiration as string = ExpirationMonthPopup.Text + right(ExpirationYearPopup.Text, 2)
	...
	#tag Method, Flags = &h0
		Function isValidData() As Boolean
		  ...
		  if ExpirationMonthPopup.ListIndex = -1 then
		    return false
		    
		  end if
		  
		  if ExpirationYearPopup.ListIndex = -1 then
		    return false
